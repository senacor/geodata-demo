...
public class CityTest {
    ...
    public void cities_with_same_name_country_and_mapposition_are_equal() {
        City cityA = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "url");
        City cityB = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "url");
    ...
    public void cities_with_different_ids_are_not_equal() {
        City cityA = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "url");
        City cityB = new City("otherId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "url");
    ...
    public void cities_with_different_names_are_not_equal() {
        City cityA = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "url");
        City cityB = new City("anyId", "Koeln", "Country", new SphericalCoordinates(0d, 0d), "url");
    ...
    public void cities_with_different_countries_are_not_equal() {
        City cityA = new City("anyId", "Duesseldorf", "DE", new SphericalCoordinates(0d, 0d), "url");
        City cityB = new City("anyId", "Duesseldorf", "BE", new SphericalCoordinates(0d, 0d), "url");
    ...
    public void cities_with_different_mappositions_are_not_equal() {
        City cityA = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "url");
        City cityB = new City("anyId", "Koeln", "Country", new SphericalCoordinates(1d, 0d), "url");
    ...
    public void wikipedia_url_uses_the_english_mobile_site() {
        City cityA = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(0d, 0d), "en.wikipedia.org/duesseldorf");
    ...
    public void map_url_uses_lat_and_lon_positions() {
        City cityA = new City("anyId", "Duesseldorf", "Country", new SphericalCoordinates(12d, 50d), "en.wikipedia.org/duesseldorf");
